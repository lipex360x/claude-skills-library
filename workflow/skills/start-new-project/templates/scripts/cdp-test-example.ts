...
// Run all: npm run test:cdp (auto-discovers all verify-*.ts in e2e/cdp/)
// Requires: test server on dedicated port with env vars (start via `npm run test:cdp:server`)
//

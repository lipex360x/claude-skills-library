...
[![NPM version](https://img.shields.io/npm/v/run-on-output.svg)](https://www.npmjs.com/package/run-on-output)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

> Monitor command output in real-time and trigger actions when specific patterns are found.

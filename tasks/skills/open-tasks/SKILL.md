...
1. Set `task-visibility.always-open` to `true` in `~/.brain/config/behavior.config.json`.
2. Resume creating and tracking tasks as normal.
3. Confirm briefly that the board is open.
